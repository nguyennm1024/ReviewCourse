...
const calculateM1 = async (generalReport, class_id, completed) => {
...
const calculateSTD1 = async (generalReport, class_id, completed) => {
    let myReports = await Report.find({class_id}).exec();
    let std1 = 0;
    myReports.forEach(element => {
...
const calculateM2 = async (generalReport, subject_id, semester_id, completed) => {
...
const calculateSTD2 = async (generalReport, subject_id, semester_id, completed) => {
    ...
    generalReport.thoiLuongMonHoc.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;

    myReports.forEach(element => {
        std1 = std1 + (generalReport.taiLieu.M2 - element.taiLieu)*(generalReport.taiLieu.M2 - element.taiLieu);
    });
    generalReport.taiLieu.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.trangBiKienThuc.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienThucHienDayDu.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienHuongDanBatDauMonHoc.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.phuongPhapGiangDay.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienTaoCoHoi.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienGiupDocLap.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienThucTien.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienSuDungCongCu.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.tacDungThongTinPhanHoi.STD2 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
}

const calculateM3 = async (generalReport, lecturerName, semester_id, completed) => {
...
const calculateSTD3 = async (generalReport, lecturerName, semester_id, completed) => {
    ...
    generalReport.thoiLuongMonHoc.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;

    myReports.forEach(element => {
        std1 = std1 + (generalReport.taiLieu.M3 - element.taiLieu)*(generalReport.taiLieu.M3 - element.taiLieu);
    });
    generalReport.taiLieu.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.trangBiKienThuc.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienThucHienDayDu.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienHuongDanBatDauMonHoc.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.phuongPhapGiangDay.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienTaoCoHoi.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienGiupDocLap.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienThucTien.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.giangVienSuDungCongCu.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
    ...
    generalReport.tacDungThongTinPhanHoi.STD3 = Math.sqrt(std1*1.0/completed);
    std1 = 0;
}
